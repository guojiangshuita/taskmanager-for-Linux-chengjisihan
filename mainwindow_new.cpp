...
void mainwindow::createActions()
{
    ...
    taskRecordAction = new QAction(tr("task &Recorder"), this);
    taskRecordAction->setShortcut(tr("CTRL+R"));
    taskRecordAction->setStatusTip(tr("Activate the task recorder"));
    taskRecordAction->setIcon(QIcon("./images/3264"));
    connect(taskRecordAction, SIGNAL(triggered()), this, SLOT(taskRecorder_activate()));
...
void mainwindow::createMenus()
{
    ...
    toolsMenu->addAction(taskRecordAction);
...
void mainwindow::loadTasks()
{
    ...
    swapTotalCondition->setText("swap Total:" + QString::number(swapTotal) + "KB");
    meminfo.close();
...
void mainwindow::createToolBar()
{
    ...
    toolToolBar->addAction(taskRecordAction);
...
void mainwindow::taskRecorder_activate()
{
